...
export interface KatexExpressionCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLKatexExpressionElement;
}
declare global {
...
declare namespace LocalJSX {
    interface KatexExpression {
         ...
         */
        "onOnError"?: (event: KatexExpressionCustomEvent<any>) => void;
    }
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "katex-expression": LocalJSX.KatexExpression & JSXBase.HTMLAttributes<HTMLKatexExpressionElement>;
        }
    }
}
